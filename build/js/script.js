...
var $WindowWidth = derivable_1.atom(window.innerWidth);
var $WindowHeight = derivable_1.atom(window.innerHeight);
window.addEventListener('resize', derivable_1.transaction(function () {
    $WindowWidth.set(window.innerWidth);
    $WindowHeight.set(window.innerHeight);
}));
var $MouseX = derivable_1.atom(0);
...
function _assign(obja, objb) {
    for (var _i = 0, _a = Object.keys(objb); _i < _a.length; _i++) {
        var key = _a[_i];
        obja[key] = objb[key];
    }
    return obja;
...
exports.px = function (v) { return v + "px"; };
